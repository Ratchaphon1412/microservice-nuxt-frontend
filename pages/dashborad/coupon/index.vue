                    ...
                    <table
                      ...
                      <thead>
                        <tr class="bg-gray-100 dark:bg-gray-900 dark:bg-opacity-40">
                          <th class="text-center" data-sortable="">
                            <a href="#" class="text-center dataTable-sorter">Coupon Name</a>
                          </th>
                          <th class="text-center hidden lg:table-cell" data-sortable="">
                            <a href="#" class="text-center dataTable-sorter mx-5">Code</a>
                          </th>
                          <th class="text-center w-1/12" data-sortable="">
                            <a href="#" class="text-center dataTable-sorter mx-5">DateExpire</a>
                          </th>
                          <th class="text-center hidden lg:table-cell w-1/12" data-sortable="">
                      ...
                      <tbody class="justify-between items-center">
                        <tr v-for="coupon in coupons">
                          ...
                          <td>
                            <p class="text-center">{{ coupon.expire_date }}</p>
                          </td>
                          <td>
                            <p class="text-center">{{ coupon.type }}</p>
                          </td>
                          <td>
                            <p class="text-center">{{ coupon.discount }}</p>
                          </td>
                          <td class="text-center">
                            <button @click="deleteCoupon(coupon.id)" class="inline-block ltr:mr-2 rtl:ml-2 hover:text-red-500"
                              title="Delete">
