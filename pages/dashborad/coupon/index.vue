                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <a href="#">
                              <div class="flex flex-wrap flex-row items-center">
                                <div class="self-center"><img class="h-8 w-8" src="../src/img/products/product1.jpg">
                                </div>
                                <div class="leading-5 dark:text-gray-300 flex-1 ltr:ml-2 rtl:mr-2 mb-1">
                                  Nike Women's Race Running Shoe
                                  <div class="pt-1 text-sm italic text-gray-500 w-full">
                          ...
                          <td class="text-center">
                            ...
                            <a href="coupon/editCoupon" class="inline-block ltr:mr-2 rtl:ml-2 hover:text-green-500"
                              title="Edit">
                              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="#">
                              <div class="flex flex-wrap flex-row items-center">
                                <div class="self-center"><img class="h-8 w-8" src="../src/img/products/product2.jpg">
                                </div>
                                <div class="leading-5 dark:text-gray-300 flex-1 ltr:ml-2 rtl:mr-2 mb-1">
                                  Nike Womens Free RN Flyknit 2018
                                  <div class="pt-3 text-sm italic text-gray-500 w-full">
                          ...
                          <td class="text-center">
                            ...
                            <a href="/editCoupon" class="inline-block ltr:mr-2 rtl:ml-2 hover:text-green-500"
                              title="Edit">
                              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-pencil-square" viewBox="0 0 16 16">
                                <path
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="#">
                              <div class="flex flex-wrap flex-row items-center">
                                <div class="self-center"><img class="h-8 w-8" src="../src/img/products/product3.jpg">
                                </div>
                                <div class="leading-5 dark:text-gray-300 flex-1 ltr:ml-2 rtl:mr-2 mb-1">
                                  Nike Women's Sneaker Running Shoes
                                  <div class="pt-3 text-sm italic text-gray-500 w-full">
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="#">
                              <div class="flex flex-wrap flex-row items-center">
                                <div class="self-center"><img class="h-8 w-8" src="../src/img/products/product4.jpg">
                                </div>
                                <div class="leading-5 dark:text-gray-300 flex-1 ltr:ml-2 rtl:mr-2 mb-1">
                                  Nike Women's Air Zoom Pegasus 36 Running Shoes
                                  <div class="pt-3 text-sm italic text-gray-500 w-full">
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="#">
                              <div class="flex flex-wrap flex-row items-center">
                                <div class="self-center"><img class="h-8 w-8" src="../src/img/products/product5.jpg">
                                </div>
                                <div class="leading-5 dark:text-gray-300 flex-1 ltr:ml-2 rtl:mr-2 mb-1">
                                  Nike Women's Air Max 270 Running Shoe
                                  <div class="pt-3 text-sm italic text-gray-500 w-full">
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="#">
                              <div class="flex flex-wrap flex-row items-center">
                                <div class="self-center"><img class="h-8 w-8" src="../src/img/products/product7.jpg">
                                </div>
                                <div class="leading-5 dark:text-gray-300 flex-1 ltr:ml-2 rtl:mr-2 mb-1">
                                  Nike Women's Gymnastics Tennis Shoes
                                  <div class="pt-3 text-sm italic text-gray-500 w-full">
