...
<!-- start = stat -->
		...
		<div class="flex-shrink max-w-full px-4 w-full lg:w-1/3 mb-6">
						...
						<div class="relative mx-auto text-center w-full sm:w-2/3 lg:w-full">
								<canvas class="max-w-100" id="DoughnutChart" style="display: block; box-sizing: border-box; height: 378px; width: 378.5px;" width="757" height="756"></canvas>
						</div>
									</div>
								</div>
		</div>
		...
		<div class="flex flex-wrap flex-row">                                                  
					<div class="flex-shrink max-w-full px-4 w-full mb-6">
						<div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg h-full">
							...
							<div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns"><div class="dataTable-top flex flex-row justify-between m-5"><div class="dataTable-dropdown"><label><select class="dataTable-selector"><option value="5">5</option><option value="10" selected="">10</option><option value="15">15</option><option value="20">20</option><option value="25">25</option></select> entries per page</label></div><div class="dataTable-search"><input class="dataTable-input" placeholder="Search..." type="text"></div></div><div class="dataTable-container"><table class="table-sorter table-bordered-bottom w-full text-gray-500 dark:text-gray-400 dataTable-table">
							<thead>
								<tr class="bg-gray-200 dark:bg-gray-900 dark:bg-opacity-40"><th data-sortable="" style="width: 14.5598%;"><a href="#" class="dataTable-sorter">
									Order ID
								</a></th><th class="hidden lg:table-cell" data-sortable="" style="width: 30.9255%;"><a href="#" class="dataTable-sorter">
									Customer
								</a></th><th data-sortable="" style="width: 17.4944%;"><a href="#" class="dataTable-sorter">
									Status
								</a></th><th class="hidden lg:table-cell" data-sortable="" style="width: 16.93%;"><a href="#" class="dataTable-sorter">
									Date Added
								</a></th><th data-sortable="" style="width: 9.25508%;"><a href="#" class="dataTable-sorter">
									Total
								</a></th><th data-sortable="false" style="width: 10.8352%;">
									Action
								</th></tr>
							</thead>
