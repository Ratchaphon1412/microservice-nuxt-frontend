                        ...
                        <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
                            ...
                            <div class="dataTable-dropdown">
                              <label>
                                <select class="dataTable-selector">
                                  ...
                                  <option value="10" selected="">10</option><option value="15">15</option><option value="20">20</option><option value="25">25</option></select> entries per page</label></div><div class="dataTable-search"><input class="dataTable-input" placeholder="Search..." type="text"></div></div><div class="dataTable-container">
                          ...
                          <thead>
                            ...
                            <th class="text-center" data-sortable="" >
                              <a href="#" class="text-center dataTable-sorter mx-10">OrderID</a>
                            </th>
                            <th class="text-center hidden lg:table-cell" data-sortable="" >
                              <a href="#" class="text-center dataTable-sorter mx-10">Customer</a>
                            </th>
                            <th class="text-center" data-sortable="" >
                              <a href="#" class="text-center dataTable-sorter mx-10">OrderDate</a>
                            </th>
                            <th class="text-center hidden lg:table-cell" data-sortable="" >
                              <a href="#" class="text-center dataTable-sorter mx-10">Status</a>
                            </th>
                            <th class="text-center hidden lg:table-cell" data-sortable="" >
                              <a href="#" class="text-center dataTable-sorter mx-10">Total</a>
                            </th>
                          ...
                          <tbody><tr class="border-b dark:border-gray-700">
                            <td>
                              <input type="checkbox" class="checkedall form-checkbox w-4 h-4 text-indigo-500 border border-gray-300 rounded dark:bg-gray-700 dark:border-gray-700">
                            </td>
                            ...
                            <td>
                              ...
                              </td><td class="hidden lg:table-cell text-center">27/05/2022</td><td class="hidden lg:table-cell text-center">
                                <span class="text-sm px-2 py-1 font-semibold leading-tight text-yellow-700 bg-yellow-100 rounded-full ">Processing</span>
                              </td><td class="text-center">165$</td><td class="text-center">
                            ...
                            <!-- end item in table -->
                              <tr class="border-b dark:border-gray-700"><td>
                              ...
                              </td><td class="hidden lg:table-cell">27/05/2022</td><td class="hidden lg:table-cell">
                                <span class="text-sm px-2 py-1 font-semibold leading-tight text-yellow-700 bg-yellow-100 rounded-full">Processing</span>
                              </td><td class="text-center">165$</td><td class="text-center">
                                <a href="javascript:;" class="inline-block ltr:mr-2 rtl:ml-2 hover:text-red-500" title="Delete">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                              ...
                              </td><td class="hidden lg:table-cell">26/05/2022</td><td class="hidden lg:table-cell">
                                <span class="text-sm px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full">Complete</span>
                              </td><td class="text-center">165$</td><td class="text-center">
                                <a href="javascript:;" class="inline-block ltr:mr-2 rtl:ml-2 hover:text-red-500" title="Delete">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                              ...
                              </td><td class="text-center">35$</td><td class="text-center">
                                <a href="javascript:;" class="inline-block ltr:mr-2 rtl:ml-2 hover:text-red-500" title="Delete">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                                    <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"></path>
                                    <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"></path>
                              ...
                              </td><td class="hidden lg:table-cell">25/05/2022</td><td class="hidden lg:table-cell">
                                <span class="text-sm px-2 py-1 font-semibold leading-tight text-indigo-700 bg-indigo-100 rounded-full">Shipped</span>
                              </td><td class="text-center">35$</td><td class="text-center">
                                <a href="javascript:;" class="inline-block ltr:mr-2 rtl:ml-2 hover:text-red-500" title="Delete">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                              ...
                              </td><td class="hidden lg:table-cell">24/05/2022</td><td class="hidden lg:table-cell">
                                <span class="text-sm px-2 py-1 font-semibold leading-tight text-pink-700 bg-pink-100 rounded-full">Canceled</span>
                              </td><td class="text-center">35$</td><td class="text-center">
                                <a href="javascript:;" class="inline-block ltr:mr-2 rtl:ml-2 hover:text-red-500" title="Delete">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                      ...
                      <tbody>
                        <tr class="border-b dark:border-gray-700">
                          ...
                          <td>
                            <a href="#">
                              <div class="flex flex-wrap flex-row items-center">
                                <div class="self-center"><img class="h-8 w-8" src="../src/img/products/product6.jpg">
                                </div>
                                <div class="leading-5 dark:text-gray-300 flex-1 ltr:ml-2 rtl:mr-2 mb-1">
                                  Nike Women's Flex Trainer 9 Sneaker
                                  <div class="pt-3 text-sm italic text-gray-500 w-full">
                        ...
                        <tr class="border-b dark:border-gray-700">
                          ...
                          <td>
                            <a href="#">
                              <div class="flex flex-wrap flex-row justify-items-center">
                                <div class="self-center"><img class="h-8 w-8 rounded-full bg-gray-200 dark:bg-gray-600"
