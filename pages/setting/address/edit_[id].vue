        ...
        <div class="p-4 bg-white rounded-lg">
          <div class="grid grid-cols-6 gap-6 font-poppin">
            ...
            <div class="col-span-6 sm:col-span-3">
              ...
              <input
                :placeholder="address.detail_address"
                class="peer w-full border-b border-blue-gray-200 bg-transparent pt-4 pb-1.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border-blue-gray-200 focus:border-pink-500 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                name="address"
                id="address"
...
const address = ref();
address.value = await authStore().getAddressById(route.params.id);

let address_name = ref("");
let country = ref("");
let address_details = ref("");
let phone = ref("");
let city = ref("");
let zip_code = ref("");
...
async function submit() {
  if (address_name.value == "") {
    address_name.value = address.value.fullname;
  }
  ...
  if (address_details.value == "") {
    address_details.value = address.value.detail_address;
  }
  ...
  if (city.value == "") {
    city.value = address.value.province;
  }

  if (zip_code.value == "") {
    zip_code.value = address.value.zip_code;
  }
