<template>
    <div class="animate-fade-down flex-col w-full p-2">
         <div class="flex-shrink max-w-full px-4 w-full">   
                                 <p class="text-4xl text-gray-900 font-poppin mt-3 mb-5">Edit Product</p>
         </div>     
 <!-- start -->
                                    ...
                                    <div class="flex flex-col justify-col"> <label class="inline-block mb-2 text-gray-500">Upload Image</label> </div>
                                        ...
                                        <div class="flex items-center justify-center w-full">
                                            ...
                                            <div  class="grid grid-cols-2 md:grid-cols-4 gap-4 ">
                                                ...
                                                <div class="image-preview h-64 max-w-full overflow-hidden" v-for="(item, index) in imageList" :key="product.value.image_products">
...
const imageList = ref<URL[]>(product.value.image_products)
