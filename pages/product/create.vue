                ...
                <form action="#">
                    ...
                    id="selected product" class="grid grid-cols-12 gap-6 font-poppin mt-6 items-center justify-center p-6 border-10 bg-gray-900 rounded-xl">
                        ...
                        <div class="col-span-1 items-center justify-center">
                            <select id="color" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg text-center focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <option selected></option>
                                <option value="">red</option>
                            </select>
                        </div>
                        <div class="col-span-1 ">
                            <input type="color" class="rounded-lg w-3/4">
                        </div>
                        <div class="col-span-2 items-center justify-center">
